  ...
  programs.plasma = {
    ...
    configFile = {
      ...
      "kdeglobals"."KScreen"."ScreenScaleFactors".value =
        "eDP1=1.25;DP1=1.25;DP2=1.25;HDMI1=1.25;VIRTUAL1=1.25;";
      ...
      "kwinrc"."Tiling/0d3998b5-12fb-5e5d-9844-298a9a2f96a3"."tiles".value =
        "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/691c1f07-042e-533c-88fc-78e03b6fb5c1"."tiles".value =
        "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/b546cbaa-8f8b-5667-84f1-c308e262bbf5"."tiles".value =
        "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/f13a3b6b-4cec-5f6d-8e0f-ae3799822ec4"."tiles".value =
        "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
